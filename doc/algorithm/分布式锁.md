...
![lock-1 info](../../doc-img/algorithm/lock/lock-1.png)
...
![lock-2 info](../../doc-img/algorithm/lock/lock-2.jpeg)
...
![lock-3 info](../../doc-img/algorithm/lock/lock-3.jpeg)

3.临时节点（EPHEMERAL）

![lock-4 info](../../doc-img/algorithm/lock/lock-4.jpeg)
![lock-5 info](../../doc-img/algorithm/lock/lock-5.jpeg)
![lock-6 info](../../doc-img/algorithm/lock/lock-6.jpeg)
...
![lock-7 info](../../doc-img/algorithm/lock/lock-7.jpeg)

之后，Client1查找ParentLock下面所有的临时顺序节点并排序，判断自己所创建的节点Lock1是不是顺序最靠前的一个。如果是第一个节点，则成功获得锁。

![lock-8 info](../../doc-img/algorithm/lock/lock-8.jpeg)

这时候，如果再有一个客户端 Client2 前来获取锁，则在ParentLock下载再创建一个临时顺序节点Lock2。

![lock-9 info](../../doc-img/algorithm/lock/lock-9.jpeg)
...
![lock-10 info](../../doc-img/algorithm/lock/lock-10.jpeg)

这时候，如果又有一个客户端Client3前来获取锁，则在ParentLock下载再创建一个临时顺序节点Lock3。

![lock-11 info](../../doc-img/algorithm/lock/lock-11.jpeg)

Client3查找ParentLock下面所有的临时顺序节点并排序，判断自己所创建的节点Lock3是不是顺序最靠前的一个，结果同样发现节点Lock3并不是最小的。

于是，Client3向排序仅比它靠前的节点Lock2注册Watcher，用于监听Lock2节点是否存在。这意味着Client3同样抢锁失败，进入了等待状态。

![lock-12 info](../../doc-img/algorithm/lock/lock-12.jpeg)
...
![lock-13 info](../../doc-img/algorithm/lock/lock-13.jpeg)

2.任务执行过程中，客户端崩溃

获得锁的Client1在任务执行过程中，如果Duang的一声崩溃，则会断开与Zookeeper服务端的链接。根据临时节点的特性，相关联的节点Lock1会随之自动删除。

![lock-14 info](../../doc-img/algorithm/lock/lock-14.jpeg)

由于Client2一直监听着Lock1的存在状态，当Lock1节点被删除，Client2会立刻收到通知。这时候Client2会再次查询ParentLock下面的所有节点，确认自己创建的节点Lock2是不是目前最小的节点。如果是最小，则Client2顺理成章获得了锁。

![lock-15 info](../../doc-img/algorithm/lock/lock-15.jpeg)

同理，如果Client2也因为任务完成或者节点崩溃而删除了节点Lock2，那么Client3就会接到通知。

![lock-16 info](../../doc-img/algorithm/lock/lock-16.jpeg)
...
![lock-17 info](../../doc-img/algorithm/lock/lock-17.png)
...
![lock-18 info](../../doc-img/algorithm/lock/lock-18.png)
